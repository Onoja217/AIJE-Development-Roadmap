...
export function GlobalControls(){
  ...
  return <nav aria-label={t("quickNavigation")} className="fixed bottom-4 right-4 z-[100] flex items-center gap-2 rounded-xl border bg-background/95 p-2 shadow-lg backdrop-blur">
